...
E3-B 모델·애니메이션 연결은 완료했다. E3-C의 텔레그래프와 반응성 조정은 배포했고, 최종 회피 감각 확인은 이후 행동 패키지와 함께 다시 본다. 현재 P0는 `ProductionDocs/08_ProductionRoadmap.md`의 E3-D로, 입구에서 연결 방을 지나 보상 뒤 퇴장·귀환하는 첫 물리 던전을 만든다.
