...
- 2026-07-08 update: no schema field or balance value changed. E2-B post-upgrade return guidance changes only `PlayableLoopHud` button feedback: unaffordable clicks show the missing Gold/Scrap shortfall, and successful clicks route back to Hold/Push or the next contract.
