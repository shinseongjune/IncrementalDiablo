...
- players can name why one item, contract, or upgrade is better for their current goal. E2-B contract comparison was user-accepted on 2026-07-03; the current E2-B unlock is latest reward item comparison against the equipped same-slot item;
