...
- Player-facing UI shows actions, consequences, first-session next steps, recovery meaning, and compact reward comparison; unresolved or unequipped latest rewards should keep their `Next:` decision before next-contract guidance. Do not show review/debug/render wiring status.
