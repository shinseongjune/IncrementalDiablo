...
Automation tool note: `Tools/Automation/Invoke-IncrementalDiabloChecks.ps1` owns the static phase-routing freshness contract for `10_PlayableLoopMvpAutomationPlan.md`. As of 2026-06-10 it requires Phase D, completed D0-A/D0-B/D0-C/D0-D, and D1-A as the next task; update those required tokens whenever the canonical phase/task selector advances.
