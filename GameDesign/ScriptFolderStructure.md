...
Automation tool note: `Tools/Automation/Invoke-IncrementalDiabloChecks.ps1` owns the static phase-routing freshness contract for `10_PlayableLoopMvpAutomationPlan.md`. As of 2026-06-09 it requires Phase D, completed D0-A/D0-B/D0-C, and D0-D as the next task; update those required tokens whenever the canonical phase/task selector advances.
