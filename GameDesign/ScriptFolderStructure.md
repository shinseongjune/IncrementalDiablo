...
- Player-facing UI shows actions, consequences, first-session next steps, recovery meaning, compact reward comparison, and compact defense-upgrade comparison; unresolved or unequipped latest rewards should keep their `Next:` decision before upgrade or next-contract guidance. Do not show review/debug/render wiring status.
